...
class AppRoutes {
  ...
  static const String productosSeleccion = 'productosSeleccion'; // ProductosPage(isForSelection)
  static const String clientes = 'clientes'; // ClientesPage
  static const String clientesSeleccion = 'clientesSeleccion'; // ClientesPage(isForSelection)
  static const String config = 'config'; // ConfiguracionPage
  static const String rutas = 'rutas'; // RutasPage
  static const String nuevaVenta = 'nuevaVenta'; // VentaEncabezadoEdicionPage(ventaEnEdicion?)
  static const String modificarVenta = 'modificarVenta'; // VentaEncabezadoEdicionPage(ventaEnEdicion?)
